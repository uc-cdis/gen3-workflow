...
# Free disk space to avoid `System.IO.IOException: No space left on device` error during
# the "Prepare CI environment step".
# Copied from https://github.com/jlumbroso/free-disk-space (not using it directly because
# it's not verified on the GitHub actions marketplace)
